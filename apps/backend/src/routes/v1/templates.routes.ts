...
// Template CRUD
router.post('/', postTemplateController.createTemplate.bind(postTemplateController));
...
router.patch('/:id', postTemplateController.updateTemplate.bind(postTemplateController));
